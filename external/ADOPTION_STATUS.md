...
| `Alaveteli/mySociety` (Request State Taxonomy) | `external/alaveteli/SUBMISSION.md` | `staged` | None | `Alaveteli#Issue` (`human-gate`) | `none` | Dylan | Open issue upstream (`[HUMAN]`) |
