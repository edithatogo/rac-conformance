...
|---|---|---|---|---|
| PolicyEngine [#515](https://github.com/PolicyEngine/policyengine-core/pull/515) | Closes [#512](https://github.com/PolicyEngine/policyengine-core/issues/512) | Both In Progress | Externally blocked: first-time fork workflow approval is required and no hosted checks are reported | Maintainer approves CI, reviews, and merges/declines |
| PolicyEngine [#516](https://github.com/PolicyEngine/policyengine-core/pull/516) | Closes [#513](https://github.com/PolicyEngine/policyengine-core/issues/513) | Both In Progress | Externally blocked: first-time fork workflow approval is required and no hosted checks are reported | Maintainer approves CI, reviews, and merges/declines |
| PolicyEngine [#517](https://github.com/PolicyEngine/policyengine-core/pull/517) | Closes [#514](https://github.com/PolicyEngine/policyengine-core/issues/514) | Both In Progress | Externally blocked: first-time fork workflow approval is required and no hosted checks are reported | Maintainer approves CI, reviews, and merges/declines |
...
| RuleSpec NZ [#80](https://github.com/TheAxiomFoundation/rulespec-nz/pull/80) | Closes [#79](https://github.com/TheAxiomFoundation/rulespec-nz/issues/79) | Both In Progress | Externally blocked: hosted validation is failing and a signing key is required; local compile/Ruff/270-test evidence is not upstream CI | Maintainer resolves CI/conflict, signs manifest, and reviews/merges/declines |
