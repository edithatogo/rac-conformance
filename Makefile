.PHONY: check audit audit-test paper-artifacts paper-artifacts-write lint test validate-examples process-mappings-check process-profile-certification-check health-technology-check hardening-check release-audit converter-lint converter-test corpus-report-check harness-lint harness-test snap-runner-lint snap-runner-test nz-recon-lint nz-recon-test service-boundaries-lint service-boundaries-test docassemble-oia-clock-lint docassemble-oia-clock-test

check: audit audit-test paper-artifacts lint test validate-examples process-mappings-check process-profile-certification-check health-technology-check hardening-check release-audit converter-lint converter-test corpus-report-check harness-lint harness-test snap-runner-lint snap-runner-test nz-recon-lint nz-recon-test service-boundaries-lint service-boundaries-test docassemble-oia-clock-lint docassemble-oia-clock-test
...
process-profile-certification-check:
	PYTHONPATH=. uv run python tools/validate_process_profile_certification.py
