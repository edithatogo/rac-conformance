...
| SW-FOIPROCESS-01 | https://github.com/edithatogo/foi-process; `CITATION.cff`; v0.1.0; `2e635115f61e24d2e109d868119024a5591cce00` | Deterministic FOI integration, replay, OCEL/process projections, and provenance | Integration and process-methods evidence | Release tag and commit are pinned; Zenodo DOI is pending human deposit; FOI-O remains semantic authority |
