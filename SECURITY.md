...
Supported code is the current `main` branch. Historical design notebooks, archived conversations, staged external packets, and superseded contract versions are retained for provenance but are not production services.

This repository does not accept secrets or live personal data. Demonstrations and fixtures must remain synthetic or appropriately public and provenance-labelled.
