...
| `RISK-RELEASE-ATTESTATION` | Protected release environments and artifact attestations are not configured or verified. | Configure and verify them, or explicitly defer v1 and record the accepted limitation. |
